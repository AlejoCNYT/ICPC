# 🏆 ICPC - Repaso de Programación Competitiva

← [Volver al Inicio (Main README)](README.md)

Este archivo contiene la documentación completa en español de las soluciones de repaso para problemas de programación competitiva bajo los estándares de la **ICPC**.

## 🚀 Estructura del Repositorio

A continuación se detallan las soluciones de repaso implementadas actualmente en el repositorio:

| Problema / Archivo | Plataforma | Enfoque / Técnica Principal | Lenguaje |
| :--- | :---: | :--- | :---: |
